...
func (*TopLevel) Descriptor() ([]byte, []int) {
	return fileDescriptor_0558a3eafacd3584, []int{0}
}
...
func (m *TopLevel) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TopLevel.Merge(m, src)
}
...
func init() { proto.RegisterFile("nopkg/desc_test_nopkg_new.proto", fileDescriptor_0558a3eafacd3584) }

var fileDescriptor_0558a3eafacd3584 = []byte{
