...
type TestWellKnownTypes struct {
	StartTime            *types.Timestamp   `protobuf:"bytes,1,opt,name=start_time,json=startTime" json:"start_time,omitempty"`
	Elapsed              *types.Duration    `protobuf:"bytes,2,opt,name=elapsed" json:"elapsed,omitempty"`
	...
	Bl                   *types.BoolValue   `protobuf:"bytes,5,opt,name=bl" json:"bl,omitempty"`
	I32                  *types.Int32Value  `protobuf:"bytes,6,opt,name=i32" json:"i32,omitempty"`
	I64                  *types.Int64Value  `protobuf:"bytes,7,opt,name=i64" json:"i64,omitempty"`
	U32                  *types.UInt32Value `protobuf:"bytes,8,opt,name=u32" json:"u32,omitempty"`
	U64                  *types.UInt64Value `protobuf:"bytes,9,opt,name=u64" json:"u64,omitempty"`
	Str                  *types.StringValue `protobuf:"bytes,10,opt,name=str" json:"str,omitempty"`
	Byt                  *types.BytesValue  `protobuf:"bytes,11,opt,name=byt" json:"byt,omitempty"`
	Json                 []*types.Value     `protobuf:"bytes,12,rep,name=json" json:"json,omitempty"`
	Extras               []*types.Any       `protobuf:"bytes,13,rep,name=extras" json:"extras,omitempty"`
