...
type OneOfMessage_BinaryValue struct {
	BinaryValue []byte `protobuf:"bytes,1,opt,name=binary_value,json=binaryValue,proto3,oneof" json:"binary_value,omitempty"`
}
...
type OneOfMessage_BooleanValue struct {
	BooleanValue bool `protobuf:"varint,3,opt,name=boolean_value,json=booleanValue,proto3,oneof" json:"boolean_value,omitempty"`
}
...
type OneOfMessage_Int64Value struct {
	Int64Value int64 `protobuf:"varint,5,opt,name=int64_value,json=int64Value,proto3,oneof" json:"int64_value,omitempty"`
}
...
type OneOfMessage_FloatValue struct {
	FloatValue float32 `protobuf:"fixed32,7,opt,name=float_value,json=floatValue,proto3,oneof" json:"float_value,omitempty"`
}
type OneOfMessage_MsgValue struct {
	MsgValue *OneOfMessage `protobuf:"bytes,8,opt,name=msg_value,json=msgValue,proto3,oneof" json:"msg_value,omitempty"`
}
